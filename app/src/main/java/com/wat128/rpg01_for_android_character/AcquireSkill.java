...
class PlayerSkillList extends AcquireSkillList {
    ...
    public PlayerSkillList() {
        super(new ArrayList<AcquireSkill>(Arrays.asList(
                ...
                new AcquireSkill(2, SkillId.PowerDown, false),
                new AcquireSkill(2, SkillId.GuardUp, false),
                new AcquireSkill(2, SkillId.GuardDown, false),
                new AcquireSkill(2, SkillId.SpeedUp, false),
                new AcquireSkill(2, SkillId.SpeedDown, false))
        ));
    }
}
